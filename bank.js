var Bank = /** @class */ (function () {
    ...
    Bank.prototype.getFixedDeposit = function () {
        return "name is:" + this.custName + " with id:" + this.custId + " and account number is: " + this.custAcno + " gets 10% intrest per year";
    };
    return Bank;
}());
var bank1 = new Bank('sri', 12, 1452);
var bank2 = new Bank('nith', 45, 4712);
var bank3 = new Bank('sai', 71, 9822);
